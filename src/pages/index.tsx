                           ...
                           <Grid container className={classes.itemTopIndex}>
                              ...
                              <Grid item xs={12} p={'14px'}>
                                 ...
                                 <Typography
                                    ...
                                    fontSize="15px"
                                 >
                                    [STO 분석]⑦“투명성 확보해야 시장 커져…NH證, IB 강점 기반 발행에
                                    초점”
                                 </Typography>
                              </Grid>
                           </Grid>
         ...
         <Box display={w1024 ? 'none' : 'unset'} marginTop="10px">
            ...
            >
               <Box paddingRight="20px">
                  ...
                  >
                     인천시가 블록체인 기술에 기반한 디지털 경제 특구 조성을 위해 140여억 원을
                     투입한다고 13일 밝혔다. 시는 우선 내년부터 2027년까지 실행 전략을 담은 블록체인
                     허브 조성 마스터플랜을 수립하기로 했다. 6개월간 이뤄지는 마스터플랜 수립 용역은
                     국내·외 현황조사 및 분석을 통한 단계별 로드맵 마련과 디지털 경제
                  </Typography>
                  <Typography color="#999" fontSize="12px" display={w480 ? 'unset' : 'none'}>
