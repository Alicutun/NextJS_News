...
export default function Index() {
  ...
  return (
    <section>
      ...
      {/* Container TopIndex */}
      <Container className={w1024 ? classes.containerTopIndex : classes.displayNone}>
        <Grid container spacing={2}>
          <Grid item xs={7} className={classes.mainTopIndex}>
            {/* <Image
						...
						/> */}
            <img height="485px" src="https://img.sedaily.com/Web/BlockChain/8931.jpg" alt="" />
          </Grid>
              ...
              <Grid item xs={6} key={index}>
                <Link href="/News" style={{ textDecoration: 'none', color: 'black' }}>
                  <Grid container className={classes.itemTopIndex}>
                    <Grid item xs={12} className={classes.containerItemTopIndex}>
                      <img
                        width={'100%'}
                    ...
                    <Grid item xs={12} p={'14px'}>
                      ...
                      <Typography mt={'5px'} height={'45px'} overflow="hidden" fontSize="15px">
                ...
                <Link href="/News" style={{ textDecoration: 'none' }}>
                  <Box className={classes.boxItemLine}>
                    ...
                    <Box padding="20px 15px">
                      ...
                      <Typography fontSize="13px" height="36px" overflow="hidden" color="#666">
                        스마트사운드가 미국 원격진료 전문 회사 아조바헬스(Azova Health)에
                        스마트청진기 ‘스키퍼’를 공급한다고 3일 밝혔다. 스마트사운드는 아조바헬스와
                        최근 이같은 내용의 사업협약을 맺었다. 아조바헬스는 스마트사운드의 실시간
                        청진 기술을 자사 플랫폼에 도입한다. 양사는 향후 미국내 원격의료 플랫폼
                        회사들을 상대
                      </Typography>
      ...
      {/* Responsive Hot News */}
      <Box display={w1024 ? 'none' : ''} marginTop="10px">
        <Stack
          direction="row"
        ...
        >
          <Box paddingRight="20px">
            ...
            >
              인천시가 블록체인 기술에 기반한 디지털 경제 특구 조성을 위해 140여억 원을 투입한다고
              13일 밝혔다. 시는 우선 내년부터 2027년까지 실행 전략을 담은 블록체인 허브 조성
              마스터플랜을 수립하기로 했다. 6개월간 이뤄지는 마스터플랜 수립 용역은 국내·외 현황조사
              및 분석을 통한 단계별 로드맵 마련과 디지털 경제
            </Typography>
        ...
        <Grid container spacing={2} padding="0 20px" height="105px" overflow="hidden">
          {Array.from(Array(w480 ? 2 : 1)).map((_, index) => (
            <Grid item xs={w480 ? 6 : 12} key={index}>
